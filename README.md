...
### I'm a Software Engineer at [Tetrahex](https://tetrahex.com/) (Full Stack + DevOps developer).
...
- 🔭 I’ve worked on:
  ...
  - Built an NFT marketplace and integrated [Venly](https://www.venly.io/) APIs includes TS, Angular12, NodeJS, ExpressJS, AWS EC2/S3/Lambda
  - Led a team of developers to build backend, Admin Panel and mobile app for cognitive therapy named rauha. Also configured domain and deployed dockerized app on AWS ECS Fargate. It includes ReactJS, React native, NodeJS, ExpressJS, 
...
- Enable SAS and SAST tools named dependabot and codeQL in order to get alerts about any security or dependency vulnerabilities within app.
